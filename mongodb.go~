...
// URLRequest exists to read URLs from json
type URLRequest struct {
	URL string `json:"url"`
}

// Track contains igc track file metadata
type Track struct {
...
// NewTrackRegistration contains webhook information
...
// InitWebhook initialises the webhook collection
...
// AddNewTrackRegistration adds a webhook thing to the storage
...
// GetAllNewTrackRegistrations gets all the webhooks
...
// Delete fucking deletes a track
...
// DeleteWebhook fucking deletes a webhook
